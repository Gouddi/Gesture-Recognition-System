...
import { okGesture } from "./Gestures/OK.js"; // Import okGesture
import { peaceGesture } from "./Gestures/Peace.js"; // Import peaceGesture
    ...
    if (
      ...
      if (hand.length > 0) {
        const GE = new fp.GestureEstimator([
          ...
          thankYouGesture,
          okGesture,
          peaceGesture, // Added peaceGesture
        ]);
        ...
        if (gesture.gestures !== undefined && gesture.gestures.length > 0) {
          ...
          switch (detectedGesture) {
            ...
            case "ok":
              setGestureText("OK 👌");
              break;
            case "peace": // Added case for peaceGesture
              setGestureText("Peace ✌️");
              break;
            default:
              setGestureText("");
              break;
